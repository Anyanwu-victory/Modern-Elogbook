...
export default function IndustrySupervisorDashboard() {
      ...
      setRecentSubmissions([
        {
          ...
          date: "2025-03-24",
          status: "approved",
          student: { name: "John Doe", matricNumber: "MIU/2023/001" },
        },
        {
          _id: "2",
          title: "Week 2 Log",
          date: "2025-03-31",
          status: "pending",
          student: { name: "Jane Smith", matricNumber: "MIU/2023/002" },
        },
        {
          _id: "3",
          title: "Week 3 Log",
          date: "2025-04-07",
          status: "rejected",
          student: { name: "Bob Johnson", matricNumber: "MIU/2023/003" },
        },
      ])
  ...
  // Mock user data
  const user = { firstName: "Industry", username: "Supervisor" }
